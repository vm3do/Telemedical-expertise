    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <form action="patient/register" method="post" class="space-y-4">
                    <!-- Personal Info -->
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <textarea name="allergies" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Current Treatments</label>
                                <textarea name="currentTreatments" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center justify-between">
                    ...
                    <button class="text-sm bg-blue-100 text-blue-600 px-3 py-1 rounded-lg hover:bg-blue-200">Refresh</button>
                </h2>
                ...
                <div class="space-y-3 overflow-y-auto max-h-[600px]">
                    ...
                    <!-- More patient cards will be dynamically loaded here -->
                </div>
            </div>
        </div>
    </div>
